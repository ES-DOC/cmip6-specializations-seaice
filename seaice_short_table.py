{
    ...
    "CHANGE_HISTORY": [
        ["0.1.0", "2017-02-13", "Ruth Petrie", "Initialised"]
    ],
    "CONTACT": "Ruth Petrie",
    "CONTRIBUTORS": [
        "Jamie Rae (MOHC)",
        "Martin Vancopppenolle (IPSL)",
        "Alexandra Jahn (Univeristy of Colorado)"
    ],
    "PROPERTIES": {
        "priority1": [
            ...
            "cmip6.seaice.grid.seaice_categories.ice_thickness_distribution_scheme",
